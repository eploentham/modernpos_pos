...
namespace modernpos_pos.gui
{
    public partial class FrmCFoodsType : Form
    {
        ...
        private void setGrfFoodsType()
        {
            ...
            grfFooT.DataSource = mposC.mposDB.footDB.selectAll();
        ...
        {
            fooT = mposC.mposDB.footDB.selectByPk1(posiId);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                setArea();
                String re = mposC.mposDB.footDB.insertFoodsType(fooT, mposC.user.staff_id);
                int chk = 0;
