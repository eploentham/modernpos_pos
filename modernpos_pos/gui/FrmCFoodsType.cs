...
{
    public partial class FrmCFoodsType : Form
    {
        mPOSControl ic;
        FoodsType fooT;
        ...
        String userIdVoid = "";
        public FrmCFoodsType(mPOSControl x)
        {
            InitializeComponent();
            ic = x;
            initConfig();
        ...
        private void setGrfFoodsType()
        {
            //grfDept.Rows.Count = 7;

            grfFooT.DataSource = ic.mposDB.footDB.selectAll();
            ...
            grfFooT.Cols[colName].Caption = "ชื่อประเภท อาหาร";
            ...
            for (int i = 1; i < grfFooT.Rows.Count; i++)
            {
                grfFooT[i, 0] = i;
                if (i % 2 == 0)
                    grfFooT.Rows[i].StyleNew.BackColor = ColorTranslator.FromHtml(ic.iniC.grfRowColor);
            }
        ...
        {
            fooT = ic.mposDB.footDB.selectByPk1(posiId);
            txtID.Value = fooT.foods_type_id;
        ...
        {
            fooT.foods_type_id = txtID.Text;
            fooT.foods_type_code = txtAreaCode.Text;
            fooT.foods_type_name = txtFooTNameT.Text;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                setArea();
                String re = ic.mposDB.footDB.insertFoodsType(fooT, ic.user.staff_id);
                int chk = 0;
