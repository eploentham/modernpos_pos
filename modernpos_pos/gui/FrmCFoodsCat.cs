...
namespace modernpos_pos.gui
{
    public partial class FrmCFoodsCat : Form
    {
        ...
        private void initGrfFoodsCat()
        {
            ...
            panel2.Controls.Add(this.grfFooC);
        ...
        private void setGrfFoodsCat()
        {
            ...
            grfFooC.DataSource = ic.mposDB.foocDB.selectAll();
            ...
            for (int i = 1; i < grfFooC.Rows.Count; i++)
            {
                grfFooC[i, 0] = i;
                if (i % 2 == 0)
                    grfFooC.Rows[i].StyleNew.BackColor = ColorTranslator.FromHtml(ic.iniC.grfRowColor);
            }
        ...
        {
            fooC = ic.mposDB.foocDB.selectByPk1(posiId);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                setArea();
                String re = ic.mposDB.foocDB.insertFoodsCat(fooC, ic.user.staff_id);
                int chk = 0;
