...
namespace modernpos_pos.objdb
{
    public class FoodsToppingDB
    {
        ...
        {
            DataTable dt = new DataTable();
            String sql = "select foos." + footp.foods_topping_id + ",foos." + footp.foods_topping_name + ",foos." + footp.price +
                " From " + footp.table + " foos " +
                //"Left Join t_ssdata_visit ssv On ssv.ssdata_visit_id = bd.ssdata_visit_id " +
        ...
        {
            DataTable dt = new DataTable();
            String sql = "select footp." + footp.foods_topping_id + ",'' as img,footp." + footp.foods_topping_name + ",footp." + footp.price+", footp."+footp.foods_id +
        ...
        public List<FoodsTopping> getlFooSpecByFooId(String fooid)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                itm1.foods_id = row[footp.foods_id].ToString();
                lfooC1.Add(itm1);
            }
            return lfooC1;
        }
